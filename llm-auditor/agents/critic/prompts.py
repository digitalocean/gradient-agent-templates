# Ref:
# https://github.com/google/adk-samples/blob/3013dc440fa5cd74f02f5f3acacfc90aeb84ba9d/python/agents/llm-auditor/llm_auditor/sub_agents/critic/prompt.py
...
SEARCH_DESCRIPTION = "Use this function to search the web"
    ...
    "parameters": [
        {
            ...
            "schema": {"type": "string"},
            "required": True,
            "description": "The query string to be searched on the web",
        }
    ]
}
    ...
    "properties": [
        {
            "name": "context",
            "type": "string",
            "description": "The returned search contexts from the web search.",
        }
    ]
}
